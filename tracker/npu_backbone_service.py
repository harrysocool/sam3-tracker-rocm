...
_BIN_INT8    = "/tmp/bh_npu_backbone"      # INT8 MLIR-AIE, cos=0.932, 2.35s  (future improvement)
_BIN = _BIN_BF16 = "/tmp/bh_npu_backbone_bf16"  # BF16 MLIR-AIE, cos=0.989, 2.29s (default)
