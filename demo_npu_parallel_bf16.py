#!/usr/bin/env python3
"""NPU + GPU parallel streaming demo -- BF16 (no INT8) variant."""
...
def main():
    ...
    from tracker.npu_backbone_service import patch_sam3_with_npu_backbone, _BIN_BF16
    ...
    npu_enc = patch_sam3_with_npu_backbone(live.model, npu_bin=_BIN_BF16)
