...
| Text-prompt MIG, pipelined offline (ROCm 7.14 Docker) | **10.78** | — |
...
| J | Per-instance fixed position-encoding cache | — | **10.78** |
...
| **AMD Ryzen AI Max+ 395 (APU)** | **504px** | **12.21** (box) / **10.78** (text Docker, pipelined) | MIGraphX + MLIR |
